...
First off, thank you for considering contributing to claude-code-acp-rs.
...
[issue tracker](https://github.com/soddygo/claude-code-acp-rs/issues),
...
```shell
git clone https://github.com/soddygo/claude-code-acp-rs
